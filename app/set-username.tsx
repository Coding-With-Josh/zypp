            ...
            <View className="flex flex-col items-start justify-center w-full px-5 gap-9">
                ...
                <View className="gap-3 w-full">
                    <Text className="text-white font-semibold tracking-[-0.9] text-5xl">
                        Set <Text className="text-primary font-semibold tracking-[-0.9] text-5xl">Username</Text>
                    </Text>
                ...
                <View className="w-full gap-4">
                    <Input
                        ...
                        maxLength={24}
                        className="bg-white/5 text-xl px-5 py-4 text-white/90 font-medium border-white/10 rounded-2xl"
                        autoFocus
                    />                      

                    {/* Character Count & Validation */}
                    <View className="flex-row justify-between items-center">
                        <Text className={`text-sm ${trimmed.length > 0 && trimmed.length < 4 ? 'text-red-400' : 'text-white/60'}`}>
                ...
                <View className="w-full">
                    {isSaved ? (
                        <Animated.View style={{ transform: [{ scale: scaleAnimation }] }}>
                            ...
                            >
                                <Text className="text-primary-foreground font-semibold text-xl tracking-tight">Continue</Text>
