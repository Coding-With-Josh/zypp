        ...
        <View className="flex-1 justify-end px-6 pb-8">
          <View className="rounded-3xl overflow-hidden">
            ...
            <View className="mb-2">
              ...
              <View className="flex-row justify-between mb-2">
                {[1, 2, 3].map((num) => (
                  <TouchableOpacity
                    key={num}
                    className="w-20 h-16 rounded-full items-center justify-center active:bg-white/5"
            ...
            <View className="flex-row gap-3 mt-6">
              <TouchableOpacity
                onPress={handleClear}
                className="flex-1 bg-white/5 py-4 rounded-full items-center active:bg-white/10"
                disabled={!amount}
              >
                <Text
