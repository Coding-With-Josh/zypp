            ...
            <View className="flex flex-col items-start justify-center w-full px-5 mt-8 gap-9">
                <View className="gap-4">
                    <Text className="text-white font-semibold tracking-[-0.9] text-5xl">
                        Payment {'\n'}Infrastructure at {'\n'}
                        <Text className="tracking-[-0.9] font-semibold text-5xl text-primary">Zypp Speed</Text>
                    </Text>
                    <Text className="text-white opacity-85 font-semibold tracking-[-0.2] web:font-medium text-lg">
                        Transact onchain with or without internet. with unmatched speed and in-depth security.
                    </Text>
                </View>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => router.replace('/set-username')}
                >
                    <Text className="text-primary-foreground font-semibold text-xl">Get Started</Text>
                    <IconSymbol name="arrow.up.right" color="#081405" size={20} weight="bold" />
                </TouchableOpacity>
            </View>
        </View>
    )
