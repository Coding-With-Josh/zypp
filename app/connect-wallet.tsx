...
const ConnectWallet = () => {
    ...
    const [selectedOption, setSelectedOption] = useState<'wallet' | 'manual' | null>(null)
                ...
                <View className="gap-6">
                    ...
                    <View className="gap-3">
                        ...
                        <TouchableOpacity
                            ...
                            disabled={isLoading}
                        >
                            <Text className="text-white/80 font-semibold text-lg">Skip for now</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ) : (
                <View className="gap-6">
                    <View className="items-center justify-center gap-6">
                        <View className="w-20 h-20 bg-primary rounded-full items-center justify-center">
                            <IconSymbol name="wallet.pass" color="#081405" size={32} weight="bold" />
                        </View>
                        <View className="gap-2">
                            <Text className="text-white font-semibold text-2xl text-center">
                                Connecting Wallet...
        ...
        <View className="gap-6 w-full">
            <View className="gap-3">
                <Text className="text-white font-semibold tracking-[-2.5] text-5xl">
                    Connect <Text className="text-primary font-semibold tracking-[-2.5] text-5xl">Wallet</Text>
                </Text>
