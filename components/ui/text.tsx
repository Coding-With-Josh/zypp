...
const textVariants = cva("text-base text-foreground font-sans", {
  variants: {
    variant: {
      h1: "web:select-text text-4xl font-extrabold tracking-tight lg:text-5xl font-sans-bold",
      ...
      blockquote: "web:select-text mt-6 border-l-2 pl-6 italic font-sans-italic",
      code: "web:select-text relative rounded bg-muted px-[0.3rem] py-[0.2rem] text-sm font-semibold",
